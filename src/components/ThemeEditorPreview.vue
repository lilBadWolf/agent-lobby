...
const tokenCategories = [
  {
    ...
    tokens: [
      ...
      { name: '--color-accent-muted', label: 'Accent muted' },
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: '--color-chat-overlay', label: 'Overlay' },
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: '--color-sidebar-status-dot-glow-soft', label: 'Status dot glow soft' },
      { name: '--color-sidebar-status-dot-glow-strong', label: 'Status dot glow strong' },
    ],
  },
  {
    label: 'Sidebar presence',
    tokens: [
      { name: '--color-sidebar-dm-active', label: 'DM active' },
      { name: '--color-sidebar-dm-active-border', label: 'DM active border' },
      { name: '--color-sidebar-dm-active-glow', label: 'DM active glow' },
      { name: '--color-sidebar-dm-pending', label: 'DM pending' },
      { name: '--color-sidebar-dm-pending-border', label: 'DM pending border' },
      { name: '--color-sidebar-dm-pending-glow', label: 'DM pending glow' },
      { name: '--color-sidebar-dm-pending-glow-strong', label: 'DM pending glow strong' },
      { name: '--color-sidebar-dm-denied-border', label: 'DM denied border' },
      { name: '--color-sidebar-dm-denied-glow', label: 'DM denied glow' },
    ],
  },
  {
    label: 'User colors',
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: '--color-dmwindow-titlebar-text-shadow', label: 'Titlebar text shadow' },
      { name: '--color-dmwindow-button-border', label: 'Button border' },
      { name: '--color-dmwindow-button-hover-bg', label: 'Button hover' },
      { name: '--color-dmwindow-button-hover-border', label: 'Button hover border' },
      { name: '--color-dmwindow-close-border', label: 'Close border' },
      { name: '--color-dmwindow-close-hover-bg', label: 'Close hover background' },
      { name: '--color-dmwindow-close-hover-border', label: 'Close hover border' },
    ],
  },
  {
    label: 'DM Chat Modal',
    tokens: [
      { name: '--color-dmchatmodal-window-bg', label: 'Modal window background' },
      { name: '--color-dmchatmodal-modal-shadow', label: 'Modal shadow' },
      { name: '--color-dmchatmodal-modal-window-bg', label: 'Modal window surface' },
      { name: '--color-dmchatmodal-modal-window-shadow', label: 'Modal window shadow' },
      { name: '--color-dmchatmodal-tab-hover-bg', label: 'Tab hover' },
      { name: '--color-dmchatmodal-tab-active-bg', label: 'Active tab background' },
      { name: '--color-dmchatmodal-tab-active-window-bg', label: 'Active tab window' },
      { name: '--color-dmchatmodal-tab-active-window-box-shadow', label: 'Active tab window shadow' },
      { name: '--color-dmchatmodal-tab-bar-window-bg', label: 'Tab bar window bg' },
      { name: '--color-dmchatmodal-tab-bar-window-border', label: 'Tab bar window border' },
      { name: '--color-dmchatmodal-danger-shadow', label: 'Danger shadow' },
      { name: '--color-dmchatmodal-notice-call-border', label: 'Call notice border' },
      { name: '--color-dmchatmodal-notice-call-bg', label: 'Call notice background' },
      { name: '--color-dmchatmodal-notice-call-color', label: 'Call notice text' },
      { name: '--color-dmchatmodal-notice-info-border', label: 'Info notice border' },
      { name: '--color-dmchatmodal-notice-info-bg', label: 'Info notice background' },
      { name: '--color-dmchatmodal-notice-info-color', label: 'Info notice text' },
      { name: '--color-dmchatmodal-content-window-bg', label: 'Content window background' },
      { name: '--color-dmchatmodal-files-section-bg', label: 'Files section background' },
      { name: '--color-dmchatmodal-files-section-border', label: 'Files section border' },
      { name: '--color-dmchatmodal-files-section-window-bg', label: 'Files section window bg' },
      { name: '--color-dmchatmodal-files-section-window-border', label: 'Files section window border' },
      { name: '--color-dmchatmodal-drop-overlay-bg', label: 'Drop overlay' },
      { name: '--color-dmchatmodal-drag-over-bg', label: 'Drag-over bg' },
      { name: '--color-dmchatmodal-request-item-bg', label: 'Request item bg' },
      { name: '--color-dmchatmodal-file-item-bg', label: 'File item bg' },
      { name: '--color-dmchatmodal-send-btn-hover-shadow', label: 'Send button hover shadow' },
      { name: '--color-dmchatmodal-effect-text-shadow', label: 'Effect text shadow' },
      { name: '--color-dmchatmodal-progress-bar-bg', label: 'Progress bar bg' },
    ],
  },
  {
    label: 'DM Request',
    tokens: [
      { name: '--color-dm-request-card-bg', label: 'Request card bg' },
      { name: '--color-dm-request-card-shadow', label: 'Request card shadow' },
      { name: '--color-dm-request-info-shadow', label: 'Request info shadow' },
      { name: '--color-dm-request-call-shadow', label: 'Call shadow' },
      { name: '--color-dm-request-accept-hover', label: 'Accept hover' },
      { name: '--color-dm-request-reject-hover', label: 'Reject hover' },
    ],
  },
  {
    label: 'Auth UI',
    tokens: [
      { name: '--color-auth-surface', label: 'Auth surface' },
      { name: '--color-auth-surface-glow', label: 'Auth surface glow' },
      { name: '--color-auth-badge-bg', label: 'Badge background' },
      { name: '--color-auth-glitch-primary', label: 'Glitch primary' },
      { name: '--color-auth-glitch-secondary', label: 'Glitch secondary' },
      { name: '--color-auth-config-glow', label: 'Config glow' },
    ],
  },
  {
    label: 'Settings UI',
    tokens: [
      ...
      { name: '--color-settings-effect-overlay', label: 'Effect overlay' },
      ...
      { name: '--color-settings-video-preview-bg', label: 'Video preview bg' },
    ],
  },
  {
    label: 'AgentAmp',
    tokens: [
      ...
      { name: '--color-agentamp-button-muted-bg', label: 'Muted button bg' },
      { name: '--color-agentamp-button-muted-border', label: 'Muted button border' },
      { name: '--color-agentamp-button-muted-text', label: 'Muted button text' },
      { name: '--color-agentamp-button-muted-hover-bg', label: 'Muted hover bg' },
      { name: '--color-agentamp-button-muted-hover-text', label: 'Muted hover text' },
      { name: '--color-agentamp-button-active-shadow', label: 'Active button shadow' },
      { name: '--color-agentamp-playlist-shadow', label: 'Playlist shadow' },
      { name: '--color-agentamp-drag-outline', label: 'Drag outline' },
      { name: '--color-agentamp-track-row-border', label: 'Track row border' },
      { name: '--color-agentamp-track-hover-bg', label: 'Track hover bg' },
      { name: '--color-agentamp-track-active-glow', label: 'Track active glow' },
  ...
  },
  {
    label: 'Video',
    tokens: [
      { name: '--color-video-container-bg', label: 'Container bg' },
      { name: '--color-video-border', label: 'Border' },
      { name: '--color-video-main-shadow', label: 'Main shadow' },
      { name: '--color-video-fallback-bg', label: 'Fallback bg' },
      { name: '--color-video-fallback-box-shadow', label: 'Fallback box shadow' },
      { name: '--color-video-fallback-header-text-shadow', label: 'Fallback header text shadow' },
      { name: '--color-video-fallback-animation-text-shadow', label: 'Fallback animation text shadow' },
      { name: '--color-video-local-bg', label: 'Local bg' },
      { name: '--color-video-local-shadow', label: 'Local shadow' },
      { name: '--color-video-local-fallback-bg', label: 'Local fallback bg' },
      { name: '--color-video-button-bg', label: 'Button bg' },
      { name: '--color-video-button-hover-bg', label: 'Button hover bg' },
      { name: '--color-video-button-text-shadow', label: 'Button text shadow' },
      { name: '--color-video-button-off-text-shadow', label: 'Button off text shadow' },
      { name: '--color-video-pip-border', label: 'PIP border' },
      { name: '--color-video-pip-shadow', label: 'PIP shadow' },
      { name: '--color-video-pip-flicker-shadow', label: 'PIP flicker shadow' },
      { name: '--color-video-audio-bg', label: 'Audio bg' },
    ],
  },
];
